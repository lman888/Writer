...
int main()
{
	...
	std::cout << "Draw a Box" << std::endl;

	std::cout << "Input in the Postition X and Position Y" << std::endl;
	std::cin >> data->posX;
	std::cin >> data->posY;

	std::cout << "Input in Width and Height and finally its Roation" << std::endl;
	std::cin >> data->height;
	std::cin >> data->width;
	std::cin >> data->rotation;
